    ...
    >
      ...
      <div className="ml-3 flex-1">
        <div className="flex items-center">
          <h3 className={`text-sm sm:text-base font-medium ${item.checked ? 'text-green-900' : 'text-gray-900'}`}>
            {item.name}
            {item.required && <span className="text-red-500 ml-1">*</span>}
          </h3>
        </div>
        {item.description && (
          <p className={`mt-1 text-xs sm:text-sm ${item.checked ? 'text-green-700' : 'text-gray-600'}`}>
            {item.description}
          </p>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 flex items-center">
            ...
            <span className="text-sm sm:text-base">{t('requirements.systemTitle')}</span>
          </h3>
        ...
        {requirements.documentRequirements.length > 0 && (
          <div className="mb-6 sm:mb-8">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 flex items-center">
              <div className="w-5 h-5 sm:w-6 sm:h-6 bg-amber-100 rounded-full flex items-center justify-center mr-2 flex-shrink-0">
              ...
              <span className="text-sm sm:text-base">{t('requirements.documentsTitle')}</span>
            </h3>
        ...
        {/* 進行状況 */}
        {allRequirementsMet && (
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-green-50 rounded-md">
            <div className="flex">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-0 pt-4 sm:pt-6 border-t">
          ...
          <button
            ...
            className="px-6 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed order-1 sm:order-2"
          >
